  ...
  static async updateCatalogFilters(req: Request, res: Response) {
    try {
      const {
        ...
        catalogFilterEquipmentEnabled,
        catalogFilterStickersEnabled,
        catalogFilterContainersEnabled,
        catalogFilterAgentsEnabled,
        catalogFilterCharmsEnabled,
        catalogFilterGraffitiEnabled,
        catalogFilterPatchesEnabled,
        catalogFilterMusicKitsEnabled,
        catalogFilterCollectiblesEnabled,
        catalogFilterPassesEnabled,
        catalogFilterKeysEnabled,
        catalogFilterGiftsEnabled,
        catalogFilterToolsEnabled,
        catalogFilterTagsEnabled,
